...
function OffPlanProperties() {
    // Filter only Off-Plan projects
    const offPlanProjects = projects.filter(p => p.status.toLowerCase() === 'off-plan')

    return (
        <div>
            <h1 className='font-heading text-7xl text-center py-20'>Off-Plan Projects</h1>
                        ...
                        <div className='grid grid-cols-2 gap-1.5 rounded-xl border-2 border-gray-100 hover:scale-102 duration-100 cursor-pointer'>
                            <div className='imageDiv shadow-xl'>
                                <Image 
                                    ...
                                    height={600} 
                                    alt={p.location} 
                                    className='rounded-l-xl h-[350px]' 
                                />
                            </div>
